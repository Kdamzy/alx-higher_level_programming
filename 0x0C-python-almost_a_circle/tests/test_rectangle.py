#!/usr/bin/python3
"""Unittest for Rectangle base model"""
import io
import sys
import unittest
...
class TestRectangle_instantiation(unittest.TestCase):
    """test case for instantiation of the Rectangle."""
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for initialization of the width of Rectangle."""
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for initialization of the height Rectangle."""
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for initialization of x attribute of Rectangle."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests for updating kwargs method of the Rectangle model."""
    ...
    def test_update_kwargs_wrongs(self):
        r = Rectangle(10, 10, 10, 10, 10)
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_no_changes(self):
        r1 = Rectangle(10, 2, 1, 9, 5)
        r2 = Rectangle(3, 7, 1, 2, 8)
        r2.update(**r1.to_dictionary())
        self.assertNotEqual(r1, r2)

    def test_to_dictionary_arg(self):
        r = Rectangle(3, 7, 1, 2, 8)
        with self.assertRaises(TypeError):
            r.to_dictionary(1)
